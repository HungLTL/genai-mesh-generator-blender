...
class CraftsManPipeline():
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        system = find(cfg.system_type)(cfg.system)
        ...
        if 'num_inference_steps' in kwargs:
            system.num_inference_steps = kwargs['num_inference_steps']
        
        if 'guidance_scale' in kwargs:
            system.guidance_scale = kwargs['guidance_scale']

        if 'eta' in kwargs:
            system.eta = kwargs['eta']
    ...
    def __call__(
        ...
        if isinstance(image, torch.Tensor):
            ...
            batch_size = 1
        do_classifier_free_guidance = self.system.guidance_scale != 1.0
        ...
        latents = self.system.sample(
            ...
            steps = self.system.num_inference_steps,
            guidance_scale = self.system.guidance_scale,
            eta = self.system.eta,
            seed = seed
        )
